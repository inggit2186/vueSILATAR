				    ...
				    <div class="card media-section">
                        <div class="card-header">
                            <div class="foto centered">
                                ...
                                <h5><b>{{ user.name }}</b></h5>
                                <h5><BBadge pill variant="primary">{{ user.nomor_induk }}</BBadge><br/></h5>
                        ...
                        <div v-if="detail == 0" ref="scroll1st" class="categorieslist-section" >
                            <div class="container ">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 centered" @click.prevent="changedetail(1)">
                                        <div class="listMenu categories-content">
                                            <a href="javascript:void(0);" class="text-center aos aos-init aos-animate" data-aos="fade-up">
                                            <img :src="$assets+'/img/ikon/512.png'" style="width:100%;" alt="car1">
                                            <span><b>Data Pribadi / Personal</b></span>
                                            </a>								   
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 centered" @click.prevent="changedetail(2)">
                                        <div class="listMenu categories-content">
                                            <a href="javascript:void(0);" class="text-center aos aos-init aos-animate" data-aos="fade-up">
                                            <img :src="$assets+'/img/ikon/511.png'" style="width:100%;" alt="car1">
                                            <span><b>Data Riwayat Pendidikan</b></span>
                                            </a>								   
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 centered" @click.prevent="changedetail(3)">
                                        <div class="listMenu categories-content">
                                            <a href="javascript:void(0);" class="text-center aos aos-init aos-animate" data-aos="fade-up">
                                            <img :src="$assets+'/img/ikon/511.png'" style="width:100%;" alt="car1">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="pass-group group-img">
                                                                <span class="lock-icon"><i class="feather-phone-call" style="font-size:medium;"></i></span>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="pass-group group-img">
                                                                <i class="feather-phone-call" style="font-size:medium;"></i>
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="group-img">
                                                                <i class="feather-mail"></i>
                                                                <b-form-input id="email" v-model="datap.jurusan" type="text" class="form-control" placeholder="Jurusan Pendidikan" />
                                                            </div>
                                                        </div>
                                                    </div>											
                                                </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="pass-group group-img">
                                                                ...
                                                                <b-form-input id="pekerjaan" v-model="datap.instansi" type="text" class="form-control" placeholder="Asal Sekolah/Universitas"/>													
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="pass-group group-img">
                                                                <i class="fas fa-school"></i>
                                                                <b-form-input id="pekerjaan" v-model="datap.nomor_ijazah" type="text" class="form-control" placeholder="Nomor Ijazah"/>													
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6">
