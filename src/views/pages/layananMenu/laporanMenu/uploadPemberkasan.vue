									...
									<div class="row">
                                        <div v-for="item in syarat" id="item" :key="item.id" class="col-lg-4 col-md-4 featured-img1 centered">
                                            <div class="media-image" v-b-tooltip="item.keterangan">
                                                ...
                                                <hr/>
                                                <div v-if="request.status == 'DRAFT' || request.status == 'UNCHECK' || request.status == 'PENDING'" class="settings-upload-btn">
                                                ...
                                                <br/>
                                                <div v-if="request.status == 'DRAFT' || request.status == 'UNCHECK' || request.status == 'PENDING'">
