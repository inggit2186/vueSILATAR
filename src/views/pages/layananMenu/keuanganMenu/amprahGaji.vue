<template>
    <div class="main-wrapper">
        <usernavbar />
        <div class="page-wrapper keuangan-amprah-page">
                                ...
                                <div class="d-none d-sm-block">
									<div class="card-header">
										<h4>Rekap Amprah {{ titleamprah }}</h4>
											<VueDatePicker v-model="bulan" style="max-width: 250px; margin-left: 50%;margin-right: 10px;" month-picker auto-apply @update:model-value="get2Amprahgaji()" />
									</div>
								</div>
								<div class="d-block d-sm-none">
									<div>
										<h4>Rekap Amprah {{ titleamprah }}</h4>
											<VueDatePicker v-model="bulan" style="float:left; max-width: 60%;margin-right: 10px;" month-picker auto-apply @update:model-value="get2Amprahgaji()" />
									</div>
								</div>
								<hr/>
                            <div class="card-body">
										...
										<tbody v-else>
											...
											<tr v-for="(item,index) in paginatedItem" v-else :key="item.id">
                                                ...
                                                <td>
                                                    ...
                                                    <BButton v-else-if="loadingaksi[item.id]" pill size="sm" variant="danger"><b><i-svg-spinners-bars-scale-middle />&nbsp;Memuat data...</b></BButton>
                                                </td>
                                            </tr>
										</tbody>
                                    </table>
