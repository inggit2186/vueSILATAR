    ...
    methods: {
		addRequest() {
			if(this.navid == 1038){
				...
				this.$router.push('/laporan/penmad/TPG/Bulanan/');
			}else if(this.navid == 1082){
				this.$router.push('/laporan/penmad/TPG-Pengawas/Bulanan/');
			}else if(this.navid == 2001){
				this.$router.push('/certhalal');
