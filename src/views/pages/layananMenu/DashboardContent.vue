    ...
    <div class="dashboard-content">		
			<div class="container">			
				<div class="bookmarks-content grid-view featured-slider">
				    <div class="row">
					    <div class="col-lg-4 col-md-4 col-sm-6" v-for="item in seksi" :key="item.id">
							<div class="card aos aos-init aos-animate" data-aos="fade-up">
				    			<div class="blog-widget">
									<div class="blog-img">
					    				...
					    				<div class="fav-item">
											<span class="Featured-text">{{item.kategori}}</span>
									...
									<div class="bloglist-content">
										<div class="card-body">
											...
											<h6><router-link to="service-details">{{ item.nama }}</router-link></h6>																	 
											...
											<div class="amount-details">
												<div class="ratings">
													<span>{{ item.kepala }}</span> ({{ item.rolekepala }})
												</div>												
											</div>	
										</div>	
									</div>			 
